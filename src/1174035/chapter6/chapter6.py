...
# In[1]: buat fungsi mfcc untuk testomg
def display_mfcc(song):
    ...
    plt.show()
# In[2]: cek fungsi
display_mfcc('disco.00068.au')
# In[2]: cek fungsi
display_mfcc('disco.00068.au')
# In[2]: cek fungsi
display_mfcc('jazz.00068.au')
# In[2]: cek fungsi
display_mfcc('blues.00068.au')
# In[2]: cek fungsi
display_mfcc('classical.00068.au')
# In[2]: cek fungsi
display_mfcc('country.00068.au')
# In[2]: cek fungsi
display_mfcc('hiphop.00068.au')
# In[2]: cek fungsi
display_mfcc('jazz.00068.au')
# In[2]: cek fungsi
display_mfcc('reggae.00068.au')
# In[2]: cek fungsi
display_mfcc('reggae.00068.au')
# In[2]: cek fungsi
display_mfcc('rock.00068.au')
# In[3]: fitur ektraksi
