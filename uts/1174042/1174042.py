...
display_mfcc('singers/adele/adele-hello.mp3')
display_mfcc('singers/tulus/tulus-monokrom.mp3')
...
extract_features_song('singers/tulus/tulus-monokrom.mp3')
extract_features_song('singers/adele/adele-hello.mp3')

def generate_features_and_labels():
    all_features = []
    all_labels = []

    singers = ['adele', 'beyonce', 'justin', 'katy', 'khalid', 'lady', 'maroon', 'rihanna', 'tulus', 'tylor']
...
predict('singers/justin/justin-yummy.mp3')
predict('singers/tulus/tulus-gajah.mp3')
