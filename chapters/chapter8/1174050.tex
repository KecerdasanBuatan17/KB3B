...
\begin{enumerate}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/1.PNG}
		\caption{Teori 1}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/2.PNG}
		\caption{Teori 2}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/3.PNG}
		\caption{Teori 3}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/4.PNG}
		\caption{Teori 4}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/5.PNG}
		\caption{Teori 5}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/9.PNG}
		\caption{Teori 6}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/6.PNG}
		\caption{Teori 7}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/7.PNG}
		\caption{Teori 9}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/8.PNG}
		\caption{Teori 10}
	\end{figure}
...
\begin{enumerate}
	...
	\item Soal 2
	\hfill\break
	\lstinputlisting[firstline=34, lastline=64]{src/1174050/chapter8/run.py}
	...
	\item Soal 3
	\hfill\break
	\lstinputlisting[firstline=69, lastline=107]{src/1174050/chapter8/run.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/10.PNG}
		\caption{Praktek Soal 7}
	\end{figure}

	\item Soal 8
	\hfill\break
	\lstinputlisting[firstline=1, lastline=28]{src/1174050/chapter8/77.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/11.PNG}
		\caption{Hasil Soal 8}
	\end{figure}

	\item Soal 9
	\hfill\break
	\lstinputlisting[firstline=32, lastline=64]{src/1174050/chapter8/run.py}
	...
	\item Soal 10
	\hfill\break
	\lstinputlisting[firstline=66, lastline=107]{src/1174050/chapter8/run.py}
	...
	\item Soal 15
	\hfill\break
	\lstinputlisting[firstline=198, lastline=202]{src/1174050/chapter8/run.py}
	Kode di atas befungsi untuk melakukan load data pada dataset.

	\item Soal 16
	\hfill\break
	\lstinputlisting[firstline=204, lastline=207]{src/1174050/chapter8/run.py}
	Kode di atas berfungsi untuk membuat tensorboard yang nantinya bisa diakses melalui localhost.

	\item Soal 17
	\hfill\break
	\lstinputlisting[firstline=209, lastline=211]{src/1174050/chapter8/run.py}
	...
	\item Soal 18
	\hfill\break
	\lstinputlisting[firstline=213, lastline=219]{src/1174050/chapter8/run.py}
	...
	\item Soal 19
	\hfill\break
	\lstinputlisting[firstline=221, lastline=225]{src/1174050/chapter8/run.py}
	Batch adalah jumlah file yang akan di training.

	\item Soal 20
	\hfill\break
	\lstinputlisting[firstline=227, lastline=229]{src/1174050/chapter8/run.py}
	Kode di atas befungsi untuk untuk membuat gambar bersih dari noise dan juga menyesuaikan shape.

	\item Soal 21
	\hfill\break
	\lstinputlisting[firstline=231, lastline=233]{src/1174050/chapter8/run.py}
	Kode di atas befungsi untuk membuat sample gambar palsu yang akan diteruskan ke diskriminator.

	\item Soal 22
	\hfill\break
	\lstinputlisting[firstline=239, lastline=249]{src/1174050/chapter8/run.py}
	...
	\begin{figure}[H]
	\centering
		\includegraphics[width=4cm]{figures/1174050/chapter8/12.PNG}
		\caption{Praktek Soal 27}
	\end{figure}
	\begin{figure}[H]
        \centering
        \includegraphics[width=4cm]{figures/1174050/chapter8/13.PNG}
        \caption{Result}
        \end{figure}
