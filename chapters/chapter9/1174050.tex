...
cGANs adalah jenis GAN yang dikondisikan pada beberapa informasi tambahan.  informasi tambahan y ke Generator sebagai lapisan input tambahan. Dalam Vanilla GANs, tidak ada kontrol atas Kategori gambar yang dihasilkan. Ketika kita menambahkan kondisi y ke Generator, kita dapat menghasilkan gambar dari kategori tertentu, menggunakan y, yang mungkin jenis data, seperti label kelas atau data integer. Vanilla GANs bisa belajar hanya satu kategori dan sangat sulit untuk arsitek GANs untuk beberapa kategori. Sebuah cGAN, bagaimanapun, dapat digunakan untuk menghasilkan model multi-modal dengan kondisi yang berbeda untuk kategori yang berbeda.
	...
	\hfill \break
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/1.jpg}
		\centering
	...
	\begin{figure}[H]
    	\includegraphics[width=4cm]{figures/1174050/chapter9/2.PNG}
    	\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/3.jpg}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/4.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/5.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/6.png}
		\centering
...
\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/7.jpg}
		\centering
...
\end{figure}
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/8.png}
		\centering
	...
	\begin{figure}[H]
		\includegraphics[width=4cm]{figures/1174050/chapter9/9.png}
		\centering
...
\lstinputlisting[firstline=1, lastline=4]{src/1174050/chapter9/1174050.py}
...
\lstinputlisting[firstline=6, lastline=31]{src/1174050/chapter9/1174050.py}
...
Proses Encoder berfungsi untuk mempelajari pemetaan terbalik dari gambar wajah dan kondisi usia dengan vector latent Z.
		...
		\lstinputlisting[firstline=33, lastline=73]{src/1174050/chapter9/1174050.py}
...
Proses Generator agar bekerja dengan baik dibutuhkan representasi dari gambar wajah dan vector kondisi sebagai inputan yang menghasilkan sebuah gambar.
		...
		\lstinputlisting[firstline=75, lastline=104]{src/1174050/chapter9/1174050.py}
...
Proses Discriminator untuk membedakan antara gambar asli dan gambar palsu.
		...
		\lstinputlisting[firstline=116, lastline=148]{src/1174050/chapter9/1174050.py}
...
Proses Training cGAN ini dengan load file .mat pada dataset lalu epoch sebanuak 500 kali.
		...
		\lstinputlisting[firstline=150, lastline=167]{src/1174050/chapter9/1174050.py}
...
Initial dan Latent Vector Approximation bekerja melakukan predicsi epoch yang telah di buat sebanyak 500 kali, dan nanti hasilnya ada di folder result.
		...
		\lstinputlisting[firstline=169, lastline=217]{src/1174050/chapter9/1174050.py}
\end{enumerate}
